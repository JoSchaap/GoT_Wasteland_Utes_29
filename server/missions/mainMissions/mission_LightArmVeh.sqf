...
//	@file Args:
// Modifications made by worldtrade1101
#include "setup.sqf"
...
_cargoItem_1 = ["BTR40_MG_TK_GUE_EP1","GAZ_Vodnik_HMG","GAZ_Vodnik","BRDM2_HQ_TK_GUE_EP1","BRDM2_TK_GUE_EP1"] call BIS_fnc_selectRandom;
