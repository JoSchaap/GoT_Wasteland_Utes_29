player createDiarySubject ["404games", "Information"];
...
<br/>
	...
	Suspect a player is hacking or exploiting? Please report it at: http://www.got2dayz.nl (chat)<br/><br/>
...
"
<br/>
	The admins and some players are usually found on the GoTlike TS Server.<br/><br/>
...
A. Simply go into global chat and get the attention of one of the admins or visit www.got2dayz.nl and make a report on our chat if the offence is serious.
<br/>
"]
];